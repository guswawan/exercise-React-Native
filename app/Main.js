...
export default class Main extends Component {
    ...
    loadingItems = async () => {
        try {
            const allItems = await AsyncStorage.getItem('My Missions');
            this.setState({
                loadingItems: true,
    ...
    onDoneAddItem = () => {
        ...
        if (inputValue !== '') {
            this.setState(prevState => {
                ...
                this.saveItems(newState.alignItems);
                return { ...newState };
            });
        }
    };
    ...
    saveItems = newItem => {
        const saveItem = AsyncStorage.setItem('My Missions', JSON.stringify(newItem));
    };
